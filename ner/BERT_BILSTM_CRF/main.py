...
if __name__=="__main__":
    ...
    parser.add_argument("--logdir", type=str, default="checkpoints/03")
    ...
    parser.add_argument("--trainset", type=str, default="datam/train.txt")
    parser.add_argument("--validset", type=str, default="datam/dev.txt")
