...
# VOCAB = ('<PAD>', '[CLS]', '[SEP]', 'O', 'B-disease', 'I-disease', 'B-check', 'I-check', 'B-department',
#         'I-department', 'B-drug', 'I-drug', 'B-food', 'I-food', 'B-recipe', 'I-recipe', 'B-symptom', 'I-symptom')
VOCAB = ('<PAD>', '[CLS]', '[SEP]', 'O', 'B-Entity', 'I-Entity')
